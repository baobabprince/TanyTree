...
class NameParser:
    ...
    def detect_gender(self, full_name):
        ...
        female_names = {
            ...
            'זלאטא', 'מלכה', 'עטיל', 'פרומה', 'פעריל', 'אלטע', 'שאשע', 'איטה',
            'בריינא', 'צביה', 'חסידה', 'מרת', 'גיטא', 'הניה', 'שיינדל', 'בלומא'
        }
        ...
        male_names = {
            ...
            'שניאור', 'יוסף יצחק', 'שלום דובער', 'קלונימוס', 'קלמן', 'בנימין זאב',
            'חיים שלום', 'שמשון', 'זאב', 'יהושע', 'יחיאל', 'שלום', 'שמואל', 'כתריאל',
            'לייב', 'בער', 'מרדכי', 'יוחנן', 'אלכסנדר'
        }
